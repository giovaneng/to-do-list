...
PUT	/api/task/{id}/complete	Marca uma tarefa como concluída
...
- Rotas Node-RED
/cep (Interface de busca)
/cep/search (Lógica de busca)
/corretoras (Listagem de corretoras)
...
Execute o arquivo database/script.sql no seu servidor PostgreSQL.

Executar o back-end

cd backend/backendTodo
dotnet run
